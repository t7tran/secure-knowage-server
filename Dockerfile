...
ENV KNOWAGE_REPO_VERSION=7.2.0 \
...
# knowage patched jars
    wget https://github.com/coolersport/knowage-addon/releases/download/0.7/knowage-core-${KNOWAGE_REPO_VERSION}.jar && \
    wget https://github.com/coolersport/knowage-addon/releases/download/0.7/knowage-utils-${KNOWAGE_REPO_VERSION}.jar && \
